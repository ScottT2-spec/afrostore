  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-surface-500 mb-2">{error.message || "An unexpected error occurred."}</p>
        {error.digest && <p className="text-xs text-surface-400 mb-6 font-mono">Error ID: {error.digest}</p>}
        <button
          onClick={reset}
