...
export const metadata = { title: "Privacy Policy — AfroStore" };
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed text-gray-600">
          <section>
            ...
            <p>When you use AfroStore, we collect information you provide directly: your name, email address, business details, and payment information. We also collect usage data such as pages visited, features used, and device information to improve our service.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mt-8 mb-3">2. How We Use Your Information</h2>
            <p>We use your information to provide and improve AfroStore&apos;s services, process transactions, send important updates about your account, and provide customer support. We do not sell your personal data to third parties.</p>
          </section>
          ...
          <section>
            ...
            <p>We use essential cookies to keep you logged in and remember your preferences. We also use analytics cookies to understand how you use AfroStore so we can improve it. You can manage cookie preferences in your browser settings.</p>
          </section>
          ...
          <section>
            ...
            <p>AfroStore integrates with third-party services (payment gateways, analytics, email). These services have their own privacy policies. We only share the minimum data necessary for these integrations to function.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mt-8 mb-3">8. Changes to This Policy</h2>
            <p>We may update this privacy policy from time to time. We will notify you of significant changes via email or through a notice on our platform. Continued use of AfroStore after changes constitutes acceptance of the updated policy.</p>
          </section>
