...
const fallbackTestimonials: TestimonialCard[] = [
  {
    ...
    content:
      "I was selling only through WhatsApp and Instagram DMs. ProkipSites gave me a real store in literally 5 minutes. My sales tripled in the first month because customers could finally browse and pay directly.",
    rating: 5,
    initials: "AO",
  ...
  },
  {
    ...
    content:
      "I tried Shopify but it felt so foreign — the payments, the shipping, everything. ProkipSites just gets it. M-Pesa integration, local delivery, WhatsApp notifications. It's built for us.",
    rating: 5,
    initials: "FH",
      ...
      <div className="container-max">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-surface-500">
            Hear from merchants and shoppers across Africa who use ProkipSites every day.
          </p>
        </div>
      </div>
