...
export function CosmeticsFooter({
  ...
  const scopedCss = `
    .cf-footer a { color: rgba(0,0,0,0.55); text-decoration: none; transition: color 0.2s; }
    .cf-footer a:hover { color: #000; }

    .cf-col-brand { flex: 0 1 25%; min-width: 220px; }
    .cf-col-posts { flex: 0 1 25%; min-width: 220px; }
    .cf-col-links { flex: 0 1 17%; min-width: 140px; }
    ...
    .cf-link-list li a em { font-style: italic; }

    .cf-contact-list { list-style: none; margin: 16px 0 0; padding: 0; }
    .cf-contact-item { display: flex; align-items: flex-start; gap: 10px; margin-bottom: 10px; }
    .cf-contact-icon { width: 14px; height: 14px; flex-shrink: 0; margin-top: 4px; fill: rgba(0,0,0,0.45); }

    .cf-post-item { display: flex; gap: 12px; margin-bottom: 15px; }
    .cf-post-thumb { width: 75px; height: 65px; border-radius: 0; object-fit: cover; flex-shrink: 0; }
    .cf-post-title { font-size: 14px; color: rgba(0,0,0,0.75); font-weight: 400; margin: 0 0 4px; line-height: 1.4; }
    .cf-post-title a { color: rgba(0,0,0,0.75); }
    .cf-post-title a:hover { color: #000; }
    .cf-post-date { font-size: 12px; color: rgba(0,0,0,0.4); }
    ...
    .cf-copyrights small { font-size: 13px; color: rgba(0,0,0,0.45); }
    .cf-copyrights small a { color: rgba(0,0,0,0.45); }
    .cf-copyrights img { height: 21px; width: auto; }

    @media (max-width: 768px) {
      .cf-main-footer { gap: 0 !important; padding: 0 15px !important; }
      .cf-col-brand, .cf-col-posts, .cf-col-links {
        flex: 0 1 100% !important; min-width: 100% !important;
        border-bottom: 1px solid rgba(0,0,0,0.06);
        padding: 20px 0;
      }
      .cf-col-brand { border-bottom: 1px solid rgba(0,0,0,0.06); padding-top: 30px; }
    ...
    @media (min-width: 769px) and (max-width: 1024px) {
      .cf-col-brand, .cf-col-posts { flex: 0 1 calc(50% - 15px) !important; }
      .cf-col-links { flex: 0 1 calc(33% - 20px) !important; }
    }
  `;

  const contactIcons = {
    address: (
      <svg viewBox="0 0 477 477" className="cf-contact-icon">
    ...
    phone: (
      <svg viewBox="0 0 27 27" className="cf-contact-icon">
    ...
    fax: (
      <svg viewBox="0 0 479 479" className="cf-contact-icon">
  ...
  const renderLinkColumn = (col: FooterLinkColumn, idx: number) => {
    ...
    return (
      <div key={idx} className="cf-col-links">
        <div
          className={`cf-col-toggle-head ${isOpen ? "cf-open" : ""}`}
