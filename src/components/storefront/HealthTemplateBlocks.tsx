...
export function HealthFooter({
  logo = `${IMG}/2023/08/w-pas-logo-color.svg`,
  ...
  const defaultColumns: FooterLinkColumn[] = [
    { title: "POPULAR", links: [
      { label: "Allergy Relief", href: "#" }, { label: "Anxiety", href: "#" },
      { label: "Depression", href: "#" }, { label: "Eye & Vision", href: "#" },
      { label: "Hair", href: "#" }, { label: "Sleep", href: "#" },
    ]},
    { title: "USEFUL LINKS", links: [
      { label: "Privacy Policy", href: "#" }, { label: "Terms & Conditions", href: "#" },
      { label: "Refund Policy", href: "#" }, { label: "FAQ", href: "#" },
      { label: "Contact Us", href: "#" }, { label: "About Us", href: "#" },
    ]},
    { title: "CONNECT", links: [
  ...
  const css = `
    .hh-footer { background: #fff; border-top: 1px solid #eee; padding: 60px 0 30px; }
    .hh-footer-grid { display: grid; grid-template-columns: 1.5fr repeat(${cols.length}, 1fr); gap: 40px; margin-bottom: 40px; }
    .hh-footer-logo { height: 30px; margin-bottom: 15px; }
    .hh-footer-desc { font-family: ${TOKENS.bodyFont}; font-size: 14px; line-height: 24px; color: ${TOKENS.textColor}; margin: 0 0 20px; }
    .hh-footer-contact { font-family: ${TOKENS.bodyFont}; font-size: 14px; color: ${TOKENS.textColor}; }
    .hh-footer-contact a { color: ${TOKENS.titleColor}; text-decoration: none; }
    .hh-footer-contact a:hover { color: ${TOKENS.primaryColor}; }
    .hh-footer-col-title { font-family: ${TOKENS.titleFont}; font-weight: 500; font-size: 14px; color: ${TOKENS.titleColor}; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 15px; }
    .hh-footer-links { list-style: none; padding: 0; margin: 0; }
    .hh-footer-links li { margin-bottom: 8px; }
    .hh-footer-links a { font-family: ${TOKENS.bodyFont}; font-size: 14px; color: ${TOKENS.textColor}; text-decoration: none; transition: color 0.3s; }
    .hh-footer-links a:hover { color: ${TOKENS.primaryColor}; }
    .hh-footer-bottom { border-top: 1px solid #eee; padding-top: 20px; text-align: center; font-family: ${TOKENS.bodyFont}; font-size: 13px; color: ${TOKENS.textColor}; }
    @media (max-width: 767px) { .hh-footer-grid { grid-template-columns: 1fr; } }
  `;
