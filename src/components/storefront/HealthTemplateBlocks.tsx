...
export function HealthFooter({
  ...
  const scopedCss = `
    .ht-footer a { color: rgba(0,0,0,0.55); text-decoration: none; transition: color 0.2s; }
    .ht-footer a:hover { color: #000; }

    .ht-col-brand { flex: 0 1 25%; min-width: 220px; }
    .ht-col-posts { flex: 0 1 25%; min-width: 220px; }
    .ht-col-links { flex: 0 1 17%; min-width: 140px; }

    .ht-col-toggle-head {
      display: flex; justify-content: space-between; align-items: center;
      cursor: pointer; user-select: none; padding: 0;
    }
    .ht-col-toggle-head svg {
      width: 12px; height: 12px; fill: rgba(0,0,0,0.45);
      transition: transform 0.3s;
      display: none;
    }
    .ht-col-toggle-head.ht-open svg { transform: rotate(180deg); }
    ...
    .ht-link-list { list-style: none; margin: 0; padding: 0; }
    .ht-link-list li { margin-bottom: 10px; }
    .ht-link-list li a { font-size: 14px; }
    .ht-link-list li a em { font-style: italic; }

    .ht-contact-list { list-style: none; margin: 16px 0 0; padding: 0; }
    .ht-contact-item { display: flex; align-items: flex-start; gap: 10px; margin-bottom: 10px; }
    .ht-contact-icon { width: 14px; height: 14px; flex-shrink: 0; margin-top: 4px; fill: rgba(0,0,0,0.45); }

    .ht-post-item { display: flex; gap: 12px; margin-bottom: 15px; }
    .ht-post-thumb { width: 75px; height: 65px; border-radius: 0; object-fit: cover; flex-shrink: 0; }
    .ht-post-title { font-size: 14px; color: rgba(0,0,0,0.75); font-weight: 400; margin: 0 0 4px; line-height: 1.4; }
    .ht-post-title a { color: rgba(0,0,0,0.75); }
    .ht-post-title a:hover { color: #000; }
    .ht-post-date { font-size: 12px; color: rgba(0,0,0,0.4); }
    ...
    .ht-copyrights small { font-size: 13px; color: rgba(0,0,0,0.45); }
    .ht-copyrights small a { color: rgba(0,0,0,0.45); }
    .ht-copyrights img { height: 21px; width: auto; }

    @media (max-width: 768px) {
      .ht-main-footer { gap: 0 !important; padding: 0 15px !important; }
      .ht-col-brand, .ht-col-posts, .ht-col-links {
        flex: 0 1 100% !important; min-width: 100% !important;
        border-bottom: 1px solid rgba(0,0,0,0.06);
        padding: 20px 0;
      }
      .ht-col-brand { border-bottom: 1px solid rgba(0,0,0,0.06); padding-top: 30px; }
      .ht-col-toggle-head svg { display: block; }
      .ht-col-toggle-content { overflow: hidden; transition: max-height 0.3s ease; }
      .ht-col-toggle-content.ht-closed { max-height: 0; }
      .ht-col-toggle-content.ht-open { max-height: 500px; }
      .ht-col-title { margin-bottom: 0; }
      .ht-col-toggle-head.ht-open .ht-col-title { margin-bottom: 15px; }
    }

    @media (min-width: 769px) {
      .ht-col-toggle-content { max-height: none !important; }
    }

    @media (min-width: 769px) and (max-width: 1024px) {
      .ht-col-brand, .ht-col-posts { flex: 0 1 calc(50% - 15px) !important; }
      .ht-col-links { flex: 0 1 calc(33% - 20px) !important; }
    }
  `;

  const contactIcons = {
    address: (
      <svg viewBox="0 0 477 477" className="ht-contact-icon">
    ...
    phone: (
      <svg viewBox="0 0 27 27" className="ht-contact-icon">
    ...
    fax: (
      <svg viewBox="0 0 479 479" className="ht-contact-icon">
