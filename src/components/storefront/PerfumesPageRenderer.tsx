...
import { PerfumesStoreContext } from './PerfumesTemplateBlocks';
import {
  PerfumesHeroSlider,
  PerfumesProductGrid,
...
interface PerfumesPageRendererProps {
  sections: PerfumesSection[];
  mode: 'live' | 'edit';
...
export const PerfumesPageRenderer: React.FC<PerfumesPageRendererProps> = ({
  sections,
  mode,
  ...
  const renderBlock = (sec: PerfumesSection) => {
    ...
    switch (type) {
      ...
      case 'perfumesOlfactoryTags':
        return <PerfumesOlfactoryTags tags={props.tags as any || []} title={props.title} marginBottom={props.marginBottom} />;
      case 'perfumesMarquee':
        return <PerfumesMarquee items={props.items as any || []} speed={props.speed} marginBottom={props.marginBottom} />;
      case 'perfumesFeaturedBanners':
        return <PerfumesFeaturedBanners banners={props.banners as any || []} marginBottom={props.marginBottom} />;
      case 'perfumesTabbedProducts':
        return <PerfumesTabbedProducts tabs={props.tabs as any || []} title={props.title} columns={props.columns} maxProducts={props.maxProducts} marginBottom={props.marginBottom} />;
      case 'perfumesCollectionBanners':
        return <PerfumesCollectionBanners banners={props.banners as any || []} sectionTitle={props.sectionTitle} marginBottom={props.marginBottom} />;
      default:
