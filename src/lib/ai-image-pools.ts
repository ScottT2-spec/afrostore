...
const INDUSTRY_KEYWORDS: Record<string, string[]> = {
  fashion: ["fashion", "clothing", "apparel", "clothes", "wear", "boutique", "outfit", "garment", "textile", "sneaker", "shoe"],
  electronics: ["electronics", "tech", "gadget", "phone", "laptop", "computer", "device", "digital", "smart", "gaming"],
  beauty: ["beauty", "cosmetic", "makeup", "skincare", "skin", "hair", "nail", "perfume", "fragrance", "spa", "salon"],
  food: ["food", "restaurant", "bakery", "cafe", "catering", "meal", "cook", "kitchen", "snack", "drink", "beverage", "juice", "smoothie"],
  health: ["health", "wellness", "fitness", "gym", "supplement", "vitamin", "organic", "natural", "yoga", "pharma", "medical"],
  "real-estate": ["real estate", "property", "housing", "apartment", "rental", "land", "building", "construction", "home", "house", "estate"],
  kids: ["kids", "children", "baby", "toddler", "toy", "playful", "nursery", "infant", "child"],
  ...
  services: ["service", "consulting", "agency", "freelance", "cleaning", "laundry", "repair", "plumber", "electric"],
};
...
export function getRandomIndustryImages(industry: string): {
  ...
  return {
    ...
    showcase: pickN(pool.showcase, 4),
