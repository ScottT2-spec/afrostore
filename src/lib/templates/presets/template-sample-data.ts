...
const PERFUMES: TemplateSampleData = {
  categories: [
    { name: "For Her", slug: "for-her", description: "Feminine fragrances for every occasion", image: "https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&h=400&fit=crop", position: 0 },
    { name: "For Him", slug: "for-him", description: "Masculine scents for the modern man", image: "https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=400&h=400&fit=crop", position: 1 },
    { name: "Unisex", slug: "unisex", description: "Gender-neutral fragrances for everyone", image: "https://images.unsplash.com/photo-1594035910387-fea081ac0284?w=400&h=400&fit=crop", position: 2 },
    { name: "Gift Sets", slug: "gift-sets", description: "Curated fragrance gift sets", image: "https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=400&h=400&fit=crop", position: 3 },
    { name: "Travel Size", slug: "travel-size", description: "Compact fragrances for on the go", image: "https://images.unsplash.com/photo-1587017539504-67cfbddac569?w=400&h=400&fit=crop", position: 4 },
  ],
  products: [
    { name: "Opus Essence EDP 100ml", slug: "opus-essence-edp", description: "A luxurious blend of oud, amber, and vanilla with a deep, lasting trail.", price: 185, stock: 15, isFeatured: true, tags: ["featured", "bestseller", "for-her"], position: 1, category: "for-her", images: ["https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=700&fit=crop"] },
    { name: "Midnight Azure EDT 75ml", slug: "midnight-azure-edt", description: "Fresh and mysterious blend of bergamot, marine notes, and cedar.", price: 120, stock: 20, isFeatured: true, tags: ["featured", "new-arrival", "for-him"], position: 2, category: "for-him", images: ["https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=600&h=700&fit=crop"] },
    { name: "Golden Veil Parfum 50ml", slug: "golden-veil-parfum", description: "An opulent fragrance with notes of saffron, rose absolute, and sandalwood.", price: 220, stock: 10, isFeatured: true, tags: ["featured", "for-her"], position: 3, category: "for-her", images: ["https://images.unsplash.com/photo-1594035910387-fea081ac0284?w=600&h=700&fit=crop"] },
    { name: "Ember Glow EDP 100ml", slug: "ember-glow-edp", description: "Warm and inviting with notes of cinnamon, tobacco, and amber.", price: 145, stock: 18, isFeatured: true, tags: ["featured", "bestseller", "for-him"], position: 4, category: "for-him", images: ["https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=600&h=700&fit=crop"] },
    { name: "Étheria Unisex EDP 100ml", slug: "etheria-unisex-edp", description: "A gender-fluid fragrance with iris, white tea, and sheer musk.", price: 160, stock: 22, isFeatured: false, tags: ["new-arrival"], position: 5, category: "unisex", images: ["https://images.unsplash.com/photo-1594035910387-fea081ac0284?w=600&h=700&fit=crop"] },
    { name: "Nocturne Essence 50ml", slug: "nocturne-essence", description: "Deep and seductive with notes of black orchid, patchouli, and vanilla.", price: 175, compareAtPrice: 210, stock: 12, isFeatured: false, tags: ["sale", "for-her"], position: 6, category: "for-her", images: ["https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=700&fit=crop"] },
    { name: "Discovery Set (5 x 10ml)", slug: "discovery-set", description: "Sample our 5 bestselling fragrances in travel-friendly 10ml bottles.", price: 65, stock: 30, isFeatured: false, tags: ["bestseller", "gift"], position: 7, category: "gift-sets", images: ["https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=600&h=700&fit=crop"] },
    { name: "Travel Atomizer Set", slug: "travel-atomizer-set", description: "Refillable travel atomizer with 3 fragrance refills included.", price: 42, stock: 35, isFeatured: false, tags: ["bestseller"], position: 8, category: "travel-size", images: ["https://images.unsplash.com/photo-1587017539504-67cfbddac569?w=600&h=700&fit=crop"] },
  ],
  blogs: [
