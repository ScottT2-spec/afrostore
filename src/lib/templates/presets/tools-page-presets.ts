 ...
 * Content extracted verbatim from the Prokip LTD Tools demo sub-pages.
 * Source: https://prokip.xtemos.com/demo-tools/demo/tools/
 * Uses hardware* block types (same ElectronicsStoreContext family).
 */

/* ═══════════════════════════════════════════════════════════════
   ABOUT US PAGE
   Source: https://prokip.xtemos.com/about-us/demo/tools/
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   CONTACT US PAGE
   Source: https://prokip.xtemos.com/contact-us/demo/tools/
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   BLOG PAGE
   Source: https://prokip.xtemos.com/blog/demo/tools/
   ═══════════════════════════════════════════════════════════════ */
