...
/**
 * Ultimate One-Shot Fix for Perfumes Template
 * Full synchronization with revalidation
 */

async function ultimatePerfumesFix() {
  console.log("🚀 Ultimate One-Shot Fix for Perfumes Template\n");
  ...
  for (const site of sites) {
    ...
    // Step 1: Delete any remaining duplicate pages
    ...
    for (const slug of duplicateSlugs) {
      ...
      for (const page of duplicatePages) {
        ...
        console.log(`   ✗ Deleted duplicate: ${slug}`);
      }
    }
  ...
  console.log("\n✅ Ultimate perfumes fix complete!");
}
